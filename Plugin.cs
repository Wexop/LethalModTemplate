...
namespace ModTemplate
{
    ...
    public class ModTemplatePlugin : BaseUnityPlugin
    {
        ...
        const string GUID = "wexop.mod_template";
        const string NAME = "ModTemplate";
        const string VERSION = "1.0.0";

        public static ModTemplatePlugin instance;

        void Awake()
        {
            instance = this;
            
            Logger.LogInfo($"ModTemplate starting....");

            string assetDir = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "ModTemplate");
            AssetBundle bundle = AssetBundle.LoadFromFile(assetDir);
            
            Logger.LogInfo($"ModTemplate bundle found !");
            ...
            Logger.LogInfo($"ModTemplate is ready!");
        }
